package com.example.kaffeeorder;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        String price1 = "Price for " + quantity1 + " Cups of Cappuccino is- £" + quantity1*3;
        String price2 = "Price for " + quantity2 + " Cups of Americano is- £" + quantity2*2;
        String price3 = "Price for " + quantity3 + " Cups of Espresso is- £" + quantity3*1;
        int total = quantity1*3 + quantity2*2 + quantity3*1;
        int totNum = quantity1 + quantity2 + quantity3;
        String priceTot = "Total price for " + totNum + " Cups of Coffee is- £" + total;
